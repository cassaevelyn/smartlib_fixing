...
export function AdminLibrariesPage() {
  ...
  const handleCreateLibrary = () => {
    ...
    navigate('/admin/libraries/create')
  }

  const handleEditLibrary = (library: Library) => {
    navigate(`/admin/libraries/${library.id}`)
  }
  ...
  const handleChangeLibraryStatus = async () => {
    ...
    try {
      ...
      await adminService.updateLibrary(selectedLibrary.id, { 
        status: newStatus as Library['status']
      })
        ...
        <Box sx={{ display: 'flex', gap: 1 }}>
          ...
          <Tooltip title="Edit Library">
            <IconButton
              ...
              disabled={user?.role === 'ADMIN' && user?.managed_library_id !== params.row.id}
            >
              <Edit fontSize="small" />
            </IconButton>
          </Tooltip>
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              ...
              disabled={user?.role === 'ADMIN' && user?.managed_library_id !== selectedLibrary?.id}
            >
              Edit
            </Button>
            <Button
