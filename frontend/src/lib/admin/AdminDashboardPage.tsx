        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          <Grid item xs={12} sm={6} md={3}>
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
            >
              <Card sx={{ height: '100%', cursor: 'pointer' }} onClick={() => navigate('/superadmin/users')}>
                <CardContent>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
            >
              <Card sx={{ height: '100%', cursor: 'pointer' }} onClick={() => navigate('/superadmin/seats')}>
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
            >
              <Card sx={{ height: '100%', cursor: 'pointer' }} onClick={() => navigate('/superadmin/books')}>
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
            >
              <Card sx={{ height: '100%', cursor: 'pointer' }} onClick={() => navigate('/superadmin/events')}>
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} sm={3}>
              <Button
                ...
                fullWidth
                startIcon={<EventSeat />}
                onClick={() => navigate('/superadmin/seats')}
                sx={{ py: 1.5 }}
              >
                Manage Seats
              </Button>
            ...
            <Grid item xs={6} sm={3}>
              <Button
                ...
                fullWidth
                startIcon={<MenuBook />}
                onClick={() => navigate('/superadmin/books')}
                sx={{ py: 1.5 }}
              >
                Manage Books
              </Button>
